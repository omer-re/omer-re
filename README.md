...
**MeePo Bot** | [Python Repo](https://github.com/omer-re/meepo_bot) <br> [C++ Repo](https://github.com/omer-re/esp32_meepo/) | 🔒 | 🤷‍♂️ | `C++`, `Python`, `IoT`, `Sensors`, `Chatbot` | A home-monitoring Telegram bot reporting on room occupancy.
